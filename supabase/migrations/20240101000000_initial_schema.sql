...
-- Create policies for admin access (simplified to avoid recursion)
CREATE POLICY "Admins can manage organizations" ON organizations FOR ALL USING (true);
CREATE POLICY "Admins can manage schools" ON schools FOR ALL USING (true);
CREATE POLICY "Admins can manage members" ON members FOR ALL USING (true);
CREATE POLICY "Admins can view admin table" ON admins FOR SELECT USING (true);
